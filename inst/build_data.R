...
vcf_version <- 20180527
vcf_version_d <- "2018-05-27"
...
# Save Datasets
devtools::use_data(kinship, snps, strain_isotype, mapping_snps, gene_ids, wb_build, strain_isotype_mapping, internal = F, overwrite = T)
